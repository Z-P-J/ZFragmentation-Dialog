...
//
//public class BottomDragListDialogFragment_old<T> extends BottomDragDialogFragment
...
//    int[] iconIds;
//
//    public BottomDragListDialogFragment_old() {
...
//            selectListener.onSelect(BottomDragListDialogFragment_old.this, position, list.get(position));
//        }
//        if (checkedPosition != -1) {
...
//    }
//
//    public BottomDragListDialogFragment_old<T> setTitle(String title) {
//        this.title = title;
//        return this;
//    }
//
//    public BottomDragListDialogFragment_old<T> setData(List<T> list) {
//        this.list.addAll(list);
//        return this;
//    }
//
//    public BottomDragListDialogFragment_old<T> setIconIds(int[] iconIds) {
//        this.iconIds = iconIds;
//        return this;
//    }
//
//    public BottomDragListDialogFragment_old<T> setOnSelectListener(OnSelectListener<T> selectListener) {
//        this.selectListener = selectListener;
//        return this;
//    }
//
//    public BottomDragListDialogFragment_old<T> setCheckedPosition(int position) {
//        this.checkedPosition = position;
//        return this;
//    }
//
//    public BottomDragListDialogFragment_old<T> setSelectedPosition(int selectedPosition) {
//        this.selectedPosition = selectedPosition;
//        return this;
//    }
//
//    public interface OnSelectListener<T> {
//        void onSelect(BottomDragListDialogFragment_old<T> fragment, int position, T item);
//    }
//
//}
