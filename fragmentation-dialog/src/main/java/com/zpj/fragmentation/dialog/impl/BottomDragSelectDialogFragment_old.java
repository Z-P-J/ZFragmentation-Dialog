...
//
//public class BottomDragSelectDialogFragment_old<T> extends BottomDragDialogFragment {
//
...
//    }
//
//    public BottomDragSelectDialogFragment_old<T> setTitle(String title) {
//        this.title = title;
//        return this;
//    }
//
//    public BottomDragSelectDialogFragment_old<T> setNegativeText(String negativeText) {
//        this.negativeText = negativeText;
//        return this;
//    }
//
//    public BottomDragSelectDialogFragment_old<T> setPositiveText(String positiveText) {
//        this.positiveText = positiveText;
//        return this;
//    }
//
//    public BottomDragSelectDialogFragment_old<T> setData(List<T> list) {
//        this.list.addAll(list);
//        return this;
//    }
//
//    public BottomDragSelectDialogFragment_old<T> setMultiple(boolean isMultiple) {
//        this.isMultiple = isMultiple;
//        return this;
//    }
//
//    public BottomDragSelectDialogFragment_old<T> setSelected(int[] selected) {
...
//    }
//
//    public BottomDragSelectDialogFragment_old<T> setOnSingleSelectListener(OnSingleSelectListener<T> onSingleSelectListener) {
//        isMultiple = false;
//        this.onSingleSelectListener = onSingleSelectListener;
//        return this;
//    }
//
//    public BottomDragSelectDialogFragment_old<T> setOnMultiSelectListener(OnMultiSelectListener<T> onMultiSelectListener) {
//        isMultiple = true;
//        this.onMultiSelectListener = onMultiSelectListener;
//        return this;
//    }
//
//    public BottomDragSelectDialogFragment_old<T> setIconCallback(IconCallback<T> iconCallback) {
//        this.iconCallback = iconCallback;
//        return this;
//    }
//
//    public BottomDragSelectDialogFragment_old<T> setTitleCallback(TitleCallback<T> titleCallback) {
//        this.titleCallback = titleCallback;
//        return this;
//    }
//
//    public BottomDragSelectDialogFragment_old<T> setSubtitleCallback(SubtitleCallback<T> subtitleCallback) {
