...
//
//public class ListDialogFragment_old<T> extends CardDialogFragment
...
//                        ListDialogFragment_old.super.doShowAnimation();
//                    }
//                });
//    }
//
...
//    }
//
//    public ListDialogFragment_old<T> setItemRes(int itemRes) {
//        this.bindItemLayoutId = itemRes;
//        return this;
//    }
//
//    public ListDialogFragment_old<T> setItemLayoutRes(int itemLayoutId) {
//        this.bindItemLayoutId = itemLayoutId;
//        return this;
//    }
//
//    public ListDialogFragment_old<T> setTitle(String title) {
//        this.title = title;
//        return this;
//    }
//
//    public ListDialogFragment_old<T> setData(List<T> data) {
//        this.data.clear();
//        this.data.addAll(data);
//        return this;
//    }
//
//    public ListDialogFragment_old<T> addData(List<T> data) {
//        this.data.clear();
//        this.data.addAll(data);
//        return this;
//    }
//
//
//    public ListDialogFragment_old<T> setOnSelectListener(OnSelectListener<T> selectListener) {
//        this.selectListener = selectListener;
//        return this;
//    }
//
//    public ListDialogFragment_old<T> setOnBindViewHolderListener(IEasy.OnBindViewHolderListener<T> onBindViewHolderListener) {
//        this.onBindViewHolderListener = onBindViewHolderListener;
//        return this;
//    }
//
//    public ListDialogFragment_old<T> setOnItemClickListener(IEasy.OnItemClickListener<T> onItemClickListener) {
